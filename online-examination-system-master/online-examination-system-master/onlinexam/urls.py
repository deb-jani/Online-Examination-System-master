...
urlpatterns = [
    ...
    path('delete-question/<int:pk>', views.delete_question_view,name='delete-question'),
     path("techerpdf", views.techerpdf, name='techerpdf'),
    path("viewstudentpdf", views.viewstudentpdf, name='viewstudentpdf'),
    path("viewteachersalarypdf", views.viewteachersalarypdf, name='viewteachersalarypdf'),
    path("viewstudentmarkspdf", views.viewstudentmarkspdf, name='viewstudentmarkspdf'),
     path("viewquestionpdf", views.viewquestionpdf, name='viewquestionpdf'),
    path("viewpendingteacherpdf", views.viewpendingteacherpdf, name='viewpendingteacherpdf'),
    path("viewmarkspdf", views.viewmarkspdf, name='viewmarkspdf'),
    path("viewcoursepdf", views.viewcoursepdf, name='viewcoursepdf'),
    path("checkmarkspdf", views.checkmarkspdf, name='checkmarkspdf'),
]
